...
HD_PWD='/home/eric/lcd_hex/lcd_hex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_hex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_hex.tcl
