...
HD_PWD='/home/eric/lcd_hex/lcd_hex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_hex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd_hex.tcl -notrace
